...
% \ketqua{}
% \giamkhao{}
 \motphieuthi %Một phiếu thi, Không chạy với \onekey
%  \nhieuphieuthi
% \lietkedatrue % in phương án đúng kiểu liệt kê
...
\begin{window}[0,r,{\hspace*{1cm}\includegraphics[scale=0.5]{toan01}\hspace*{1cm}},{\label{fig:b01}}]
...
\begin{window}[0,r,{\hspace*{3cm}\includegraphics[scale=0.6]{toan04}\hspace*{3cm}},{\label{fig:formula35a}}]
Hỏi điểm biểu
...
%%9:1:21 1/5/2017Last Modification of contents