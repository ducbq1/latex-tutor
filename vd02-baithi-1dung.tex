...
%\coloigiai   \def\bonpa{\bonpak}        %In ra đáp án có lời giải
% \lietkedatrue
...
%  \selectrandomly{01cauhoi-toan-2017}{55} %P(2)
 \selectallproblems{2017-cauhoi-toan-1dung} %P(3)
\begin{examclosing}
\centerline{-- HẾT --}
\end{examclosing}
 \end{vnmultiplechoice}
\end{document}
http://www.mediafire.com/file/6by2bj54c5y1pg0/mau-lamdethi-tracnghiem.zip
https://nhdien.files.wordpress.com/2017/01/taodethitracnghiem.pdf