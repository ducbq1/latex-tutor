...
\begin{document}
\setlength{\baselineskip}{12truept}
\loadrandomproblems[matching]{1}{vd04-cauhoi-tuongung} %PA(1)

\begin{vnmatching}[title={\bf Câu hỏi ghép nối}]

\foreachproblem[matching]{\thisproblem} %P(1)
% \selectrandomly{cauhoi04-matching}{10} %P(2)
%  \selectallproblems{cauhoi04-matching} %P(3)
