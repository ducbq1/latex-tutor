...
{\sai {$y_{\mbox{\scriptsize \textit{CĐ} }}=-1$.}}
\loigiai{\textbf{Đáp án A:} Ta có $y=x^3-3x+2$; $y'=3x^2-3$; $y'=0 \Leftrightarrow x=\pm 1$.\\
...
\loigiai{\textbf{Đáp án A}: $y=\dfrac{x^2+3}{x-1}$.\\
...
{\sai{$m=\dfrac{1}{\sqrt[3]{9}}$.}}
{\sai {$m=1$.}}
\loigiai{\textbf{Đáp án A}: $y=x^4+2mx^2+1$; $y'=4x^3+4mx$; 
$ y'=0\Leftrightarrow 4x(x^2+m)=0 \Leftrightarrow
\left[\begin{matrix}
x=0;\\ 
x^2=-m\\ 
\end{matrix}\right.
...
{\sai{$x=80$.}}
{\sai {$x=82$.}}
\loigiai{ \textbf{Đáp án A}:Điện $x>1$.\\
Phương trình $\Leftrightarrow x-1=64\Leftrightarrow x=65$.Chọn đáp án: A.
}
}
...
\loigiai{\textbf{Đáp án A}: $y'=13^x.\ln 13$.
Chọn đáp án A.
}
}
...
{\sai{$x<3$.}}
{\sai {$x>\dfrac{10}{3}$.}}
\loigiai{\textbf{Đáp án  A}: Điều kiện: $x>\dfrac{1}{3}$. BPT $\Leftrightarrow 3x-1>8\Leftrightarrow x>3$.
...
{\sai {$\mathcal{D}=(-1;3)$.}}
\loigiai{\textbf{Đáp án A}:
$x^2-2x-3>0\Leftrightarrow x\in (-\infty;-1)\cup (3;+\infty)$. Chọn đáp án A.
}
}
...
$\Leftrightarrow x+x^2\log_2 7<0\Leftrightarrow x\log_7 2+x^2<0$. Chọn A.
}
}
...
\loigiai{\textbf{Đáp án A}: $\log_{a^2}(ab)=\dfrac{1}{2}\log_a(ab)=\dfrac{1}{2}(1+\log_a b)=\dfrac{1}{2}+\dfrac{1}{2}\log_ab$.
}
}
...
{\sai {$y'=\dfrac{1+2(x+1)\ln 2}{2^{x^2}}$.}}
\loigiai{\textbf{Đáp án A}: $y=\dfrac{x+1}{4^x}$\\
$y'=\dfrac{4^x-4^x.(x+1)\ln 4}{4^{2x}}=\dfrac{1-2(x+1)\ln 2}{2^{2x}}$. Chọn đáp án A.
}
}
...
\loigiai{\textbf{Đáp án A}: $\log_645\dfrac{\log_345}{\log_36}=\dfrac{\log_3(3^2.5)}{\log_3(2.3)}=\dfrac{2+\log_35}{1+\log_32}=\dfrac{2+\dfrac{1}{b}}{1+\dfrac{1}{b}}=\dfrac{2ab+a}{ab+b}$. Chọn A.
}
}
...
\loigiai{\textbf{Đáp án A}: Lãi suất 12\% / năm = 1\% / tháng (do vay ngắn hạn).\\
...
$(100.1,01^2-2,01m).1,01-m=100.1,01^3-3,0301m=0\Rightarrow m=\dfrac{100.1,01^3}{3,0301}=\dfrac{1,01^3}{1,01^3-1}$ (triệu đồng). Chọn A.
}
}
...
\loigiai{\textbf{Đáp án A}: $\int\sqrt{2x-1}dx=\dfrac{1}{2}\int(2x-1)^{\tfrac{1}{2}}d(2x-1)=\dfrac{1}{2}.\dfrac{(2x-1)^{\tfrac{3}{2}}}{\dfrac{3}{2}}+C=\dfrac{1}{3}(2x-1)\sqrt{2x-1}+c $. Chọn A.
}
}
...
{\sai {2m.}}
{\sai {20m.}}
\loigiai{\textbf{Đáp án A}: Ô tô còn đi thêm được 2 giây. \\
Quãng đường cần tìm là $s=\int\limits_0^2 v(t)dt=\int\limits_0^2(-5t+10)dt=\left(-\dfrac{5t^2}{2}+10t\right)\big|_0^2=10(m)$. Chọn A.
}
}
...
{\sai {$I=-\pi^4$.}}
{\sai {$I=-\dfrac{1}{4}$.}}
\loigiai{\textbf{Đáp án A}: Sử dụng máy tính. I = 0. Chọn A.
}   
}
...
$I=\dfrac{x^2\ln x}{2}\bigg|_1^e-\int\limits_1^e\dfrac{x}{2}dx=\dfrac{e^2}{2}-\left(\dfrac{e^2}{4}-\dfrac{1}{4}\right)=\dfrac{e^2+1}{2}$. Chọn A.
}  
}
...
{\sai {$V=(4-2e)\pi$.}}
{\sai {$V=e^2-5$.}}
\loigiai{\textbf{Đáp án A}: Xét giao điểm $2(x-1)e^x=0\Leftrightarrow x=1$. Thể tích cần tính:\\
$V=\pi\int \limits  _0^1\left[2(x-1)e^x\right]^2dx=4\pi\int \limits_0^1 (x-1)^2e^{2x}dx=\pi(e^2-5)$ (dùng máy tính thử). Chọn A.
}  
}
...
{\sai {$|z_1+z_2|=1$.}}
{\sai {$|z_1+z_2|=5$.}}
\loigiai{\textbf{Đáp án A}: $z_1+z_2=3-2i\Rightarrow |z_1+z_2|=\sqrt{3^2+(-2)^2}=\sqrt{13}$. Chọn A.
}  
}

\baitracnghiem{t2017:b31}{%
Cho số phức $z$ thỏa mãn $(1+i)z=3-i$ . 
\begin{window}[0,r,{\hspace*{3cm}\includegraphics[scale=0.6]{toan04}\hspace*{3cm}},{\label{fig:b31}}]
Hỏi điểm biểu
...
{\sai {Điểm $M$.}}
{\sai {Điểm $N$.}}
\loigiai{\textbf{Đáp án A}: $(1+i)z=3-i\Rightarrow z=\dfrac{3-i}{1+i}=1-2i\Rightarrow Q(1;-2)$ là điểm biểu diễn $z$. Chọn A.
}  
}
...
{\sai {$w=3+7i$.}}
{\sai {$w=-7-7i$.}}
\loigiai{\textbf{Đáp án A}: $\bar z=2-5i\Rightarrow w=i(2+5i)+2-5i=-3-3i$.
  Chọn A.
}  
}
...
z=\pm i\sqrt3\\ 
\end{matrix}\right.$.\\
 $\Rightarrow T=2+2+\sqrt3+\sqrt3=4+2\sqrt3$. Chọn A.
}  
}
...
$16=|z|^2=\left(\dfrac{3x-4y+4}{25}\right)^2+\left(\dfrac{4x+3y-3}{25}\right)\Rightarrow x^2+(y-1)^2=400\Rightarrow r=20$. Chọn A.
}  
}
...
{\sai {$V=\sqrt2 a^3$.}}
\loigiai{\textbf{Đáp án A}: $V=\dfrac{1}{3}SA.S_{ABCD}=\dfrac{1}{3}a\sqrt2 a^2=\dfrac{\sqrt2 a^3}{3}$. Chọn A.
}  
}
...
\loigiai{\textbf{Đáp án A}: $V_{ABCD}=\dfrac{1}{6}AB.AC.AD=28a^3\Rightarrow V_{AMNP}=\dfrac{1}{4}V_{ABCD}=7a^3$. Chọn A.
}  
}
...
Có $\dfrac{1}{HK^2}=\dfrac{1}{HS^2}+\dfrac{1}{HD^2}\Rightarrow HK=\dfrac{2}{3}a\Rightarrow d=\dfrac{4}{3}a$. Chọn A.
}  
}
...
$S_1=\dfrac{a^2}{4\pi}; S_2=2.\dfrac{\left(\tfrac{a}{2}\right)}{4\pi}=\dfrac{a^2}{8\pi}\Rightarrow \dfrac{S_1}{S_2}=2\Rightarrow \dfrac{V_1}{V_2}=2$. Chọn A.
}  
}
...
{\sai {$S_{tp}=10\pi$.}}
\loigiai{\textbf{Đáp án A}:
Hình trụ có bán kính đáy $r = 1$, chiều cao $h = 1$ nên có $S_{\varphi}=2\pi r^2+2\pi r h=4\pi$. Chọn A.
}  
}
...
Thể tích $V=\dfrac{4}{3}\pi R^3= \dfrac{5\sqrt{15}\pi}{54}$. Chọn B.
}  
}
...
\loigiai{\textbf{Đáp án A}:
Có (P): $3x + 0y - z + 2 = 0$ nên $(3;0;-1)$ là 1 VTPT của (P). Chọn A.
}  
}
...
{\sai {$d=\dfrac{5}{29}$.}}
{\sai {$d=\dfrac{\sqrt5}{3}$.}}
\loigiai{\textbf{Đáp án A}: $d(A;(P))=\dfrac{|3.1+4.(-2)+2.3+4|}{\sqrt{3^2+4^2+2^2}}
=\dfrac{5}{\sqrt{29}}$. Chọn A.
}  
}
...
$(d)\perp (P)\Leftrightarrow (10;2;m)=k.(5;1;1)\Leftrightarrow k=2$ và $m=2$. Chọn A.
}  
}
...
{\sai {$ x + 3y + 4z - 26 = 0$.}}
\loigiai{\textbf{Đáp án A}:
(P) nhận   $\overrightarrow{AB}=(1;1;2)$ làm VTPT. (P) qua $A\Rightarrow$ (P): $x+y-1+2(z-1)=0\Leftrightarrow x+y+2z-3=0$. Chọn A.
}  
}
...
Bán kính mặt cầu là $R=\sqrt{d^2+1^2}=\sqrt{10}\Rightarrow (S): (x-2)^2+(y-1)^2=10$. Chọn A.
}  
}
...
Phương trình đường thẳng cần tìm là $AB$: $\dfrac{x-1}{1}=\dfrac{y}{1}=\dfrac{z-2}{-1}$. Chọn A.
}  
}
