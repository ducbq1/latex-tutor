...
%  \ExcludePreviousFile[3]{dadung-f1.tex}
\ExcludePreviousFile[5]{dadung-f1.tex}
% \SetUsedFileName{delai.tex}
%  \selectrandomly{cauhoi02-dtracnghiem}{10}
% \loadrandomproblems[dtn]{10}{cauhoi02-dtracnghiem}
\begin{document}

\setlength{\baselineskip}{12truept}
% \setlength{\shortitemwidth}{0.20\textwidth}
% \loadrandomproblems[dtracnghiem]{12}{cauhoi02-dtracnghiem} %PA(1)
 \begin{vnmultiplechoice}[keycolumns=2]%

% \foreachproblem[dtn]{\thisproblem} %P(1)
%  \selectrandomly{cauhoi02-dtracnghiem}{12} %P(2)
